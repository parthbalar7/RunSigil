...
Do not report vulnerabilities in public issues. Email `security@runsigil.io` with a
description, affected versions, reproduction steps, and impact. This address is a
project governance target and must be configured by the publishing maintainers
before a public release.

The maintainers aim to acknowledge a report within three business days, provide a
