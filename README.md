...
This repository delivers **Milestone 0**, the first **Milestone 1** governed-action
vertical slice, and the first **Milestone 2** protocol-ingress slice. A
...
and it does not execute arbitrary agent processes. Framework adapters, Workflow
Engine v2, enterprise SSO, production containment, and hardened cloud deployment
...
- Budget reservation before protected work is eligible for execution.
...
OpenTelemetry GenAI conventions, expanded budget scopes, DLQ tooling, framework
adapters, and completion of later milestones. Report vulnerabilities according to
